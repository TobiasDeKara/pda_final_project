...
table_9 <- tibble(Characteristic = "Count of Types of Restrictions",
                  ...
                  "95% CI lower" = model_no_dist$coefficients[2,1]*1000-model_no_dist$coefficients[2,2]*1.96,
                  "95% CI upper" = model_no_dist$coefficients[2,1]*1000+model_no_dist$coefficients[2,2]*1.96,
                  "p-value" = c(p)) %>% 
...
table_10 <- tibble(Characteristic = c("Count of Types of Restrictions", "Distance to Provider",
                  ...
                  "95% CI lower" = c(model_dist$coefficients[2,1]*1000-model_dist$coefficients[2,2]*1.96,
                                     model_dist$coefficients[3,1]*1000-model_dist$coefficients[3,2]*1.96,
                                     model_dist$coefficients[4,1]*1000-model_dist$coefficients[4,2]*1.96),
                  "95% CI upper" = c(model_dist$coefficients[2,1]*1000+model_dist$coefficients[2,2]*1.96,
                                     model_dist$coefficients[3,1]*1000+model_dist$coefficients[3,2]*1.96,
                                     model_dist$coefficients[4,1]*1000+model_dist$coefficients[4,2]*1.96),
                  "p-value" = c(p_1, p_2, p_3)) %>%
