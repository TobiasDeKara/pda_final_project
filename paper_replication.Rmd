...
BIG PROBLEM: data on abortion restrictions starts at the end of December 2018, but data on abortion counts only goes up to (max) 2018
   * Option 1: Somehow find abortion restriction data from before December 2018 - I tried with no luck yet
   * Option 2: Somehow find abortion count data for 2019 on - Also tried with no luck yet 
         - I found this by state but not by county.
...
TODO: Calculate abortion rates by county
