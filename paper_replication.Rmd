...
to_adjust_kable_table_numbers <- kable(table_1)
```
...
table_ext_no_dist <- tibble(Characteristic = "Number of Types of Restrictive Legislation",
  ...
  kbl(caption = "Change in Abortions per 1000 Women in Model without Distances, all 50 States", digits = 3)
table_ext_no_dist
```
...
table_ext_dist <- tibble(Characteristic = c("Number of Types of Restrictive Legislation", 
  ...
  kbl(caption = "Change in Abortions per 1000 Women in Model with Distances, all 50 States", digits = 3)
table_ext_dist
```
