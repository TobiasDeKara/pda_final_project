...
table_no_dist <- tibble(Characteristic = "Count of Types of Restrictions",
                  ...
                  "p-value" = c(p)) %>% 
  kbl(caption = "State Data: Abortion Rate per 1000 Women in Model without Distances", 
          digits = 4) %>%
  kable_styling(latex_options = 'hold_position')
table_no_dist
...
table_dist <- tibble(Characteristic = c("Count of Types of Restrictions", "Distance to Provider",
  ...
  kbl(caption = "State Data: Change in Abortion Rate 1000 Women in Model with Distances") %>%
  kable_styling(latex_options = 'hold_position')
table_dist
```
...
table_9 <- tibble(Characteristic = "Count of Types of Restrictions",
                  Beta = model_no_dist$coefficients[2],
                  "p-value" = c(p)) %>% 
  kbl(caption = "State Data: Change in Birth Rate per 1000 People in Model without Distances", 
          digits = 4) %>%
  kable_styling(latex_options = 'hold_position')
table_9
...
table_no_dist <- tibble(Characteristic = "Count of Types of Restrictions",
                  Beta = model_no_dist$coefficients[2],
                  "p-value" = c(p)) %>% 
  kbl(caption = "State Data: Change in Fertility Rate per 1000 Women in Model without Distances", 
          digits = 4) %>%
  kable_styling(latex_options = 'hold_position')
table_no_dist
...
table_no_dist <- tibble(Characteristic = "Count of Types of Restrictions",
                  Beta = model_no_dist$coefficients[2],
                  "p-value" = '< 0.001') %>% 
  kbl(caption = "State Data: Change in Infant Death Rate per 1000 **** in Model without Distances", 
          digits = 4) %>%
  kable_styling(latex_options = 'hold_position')
table_no_dist
