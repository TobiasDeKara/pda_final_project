...
We then expand the analysis by using data from all 50 states, and by using an integer variable for the extent of abortion restriction legislation. Finally we extend the analysis to include associations of restrictive abortion legislation with fetal mortality, infant mortality, birth rate and fertility rate.
